...
export function Timeline$1_$reflection(gen0) {
    return record_type("Van.TimelineElement.Timeline`1", [gen0], Timeline$1, () => [["lastVal", gen0], ["lastFns", list_type(lambda_type(gen0, unit_type))], ["el", StateElement$1_$reflection(gen0)]]);
}
