...
import { NullableT$1, NullableT$1__get_Value } from "./x-nullable.fs.js";
import { append, singleton } from "../../fable_modules/fable-library-js.4.16.0/List.js";
import { Timeline } from "./timeline-element.fs.js";
import { hasValue, nextTN } from "./x-timeline-element-nullable.fs.js";
...
export function ListResult$1_$reflection(gen0) {
    return record_type("Van.TimelineElementTaskAnd.ListResult`1", [gen0], ListResult$1, () => [["results", list_type(gen0)]]);
}
...
export function op_PlusAmp(task1, task2) {
    return (timelineResult) => ((previousResult) => {
        taskAnd(task1, task2, timelineResult, previousResult);
    });
}
